/*
 * variation.c: Vehicular Container Placement Problem - Genetic Operators Functions
 * Date: 01-12-2019
...
int is_dominated(float ** solutions, int a, int b) {
	float totalA = (0.25 * solutions[a][0]) - (0.25 * solutions[a][1]) + (0.25 * solutions[a][2]) - (0.25 * solutions[a][3]);
	float totalB = (0.25 * solutions[b][0]) - (0.25 * solutions[b][1]) + (0.25 * solutions[b][2]) - (0.25 * solutions[b][3]);
	if (totalA > totalB) {
		return 1;
	}
...
int** population_evolution(int **P, int **Q, float **objectives_functions_P, float **objectives_functions_Q, int *fronts_P, int number_of_individuals, int v_size)
{
	...
	while (iterator_P < number_of_individuals)
	{
		...
		for (iterator = 0; iterator < number_of_individuals*2 ; iterator++)
		{
			...
			objectives_functions_PQ[iterator][2] !=0 || objectives_functions_PQ[iterator][3] !=0 ||
		objectives_functions_PQ[iterator][4] !=0)
				{
